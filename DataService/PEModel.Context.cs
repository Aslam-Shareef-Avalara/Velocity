...
namespace DataService
{
    ...
    public partial class PEntities : DbContext
    {
        ...
        public virtual int SetGoal(Nullable<System.Guid> goalId, Nullable<System.Guid> modifiedBy, string goalText, Nullable<bool> @fixed, Nullable<int> orgId, Nullable<System.Guid> employeeId, Nullable<System.Guid> managerId, Nullable<long> evaluationCycleId, Nullable<int> weightage)
        {
            ...
            var goalTextParameter = goalText != null ?
                new ObjectParameter("GoalText", goalText) :
                new ObjectParameter("GoalText", typeof(string));
    
            var fixedParameter = @fixed.HasValue ?
                new ObjectParameter("fixed", @fixed) :
                new ObjectParameter("fixed", typeof(bool));
            ...
            var managerIdParameter = managerId.HasValue ?
                ...
                new ObjectParameter("ManagerId", typeof(System.Guid));
    
            var evaluationCycleIdParameter = evaluationCycleId.HasValue ?
                new ObjectParameter("EvaluationCycleId", evaluationCycleId) :
                new ObjectParameter("EvaluationCycleId", typeof(long));
    
            var weightageParameter = weightage.HasValue ?
                new ObjectParameter("Weightage", weightage) :
                new ObjectParameter("Weightage", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SetGoal", goalIdParameter, modifiedByParameter, goalTextParameter, fixedParameter, orgIdParameter, employeeIdParameter, managerIdParameter, evaluationCycleIdParameter, weightageParameter);
        }
    }
}
